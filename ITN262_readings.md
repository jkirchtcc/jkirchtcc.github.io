...
**Video: Learning DNS By Cricket Liu *(Sections on Query Tools - nslookup and dig)***\
...
**Video: `(Optional - Advanced topic)` Visualizing Logs Using ElasticSearch, Logstash and Kibana**\
